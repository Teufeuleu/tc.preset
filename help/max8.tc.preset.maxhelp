        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 313.0, 205.0, 138.0, 22.0 ],
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 202.0, 265.0, 391.0, 79.0 ],
                                    "text": "For color modes 2 and 3 to work, you need to add a pattr object named 'preset_metadata' to your patch. If using subscribe mode, make sure to add preset_metadata to the pattrstorage's subscribe list.\nPreset color data will be stored just like your other parameters."
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 3,
                                    "outlettype": [ "", "", "" ],
                                    "patching_rect": [ 322.0, 346.0, 126.0, 22.0 ],
                                    "restore": [ "{\"color\":[0,0.7050556385457685,0.10690711578119372,0.23966901936985963,1],\"uid\":0}" ],
                                    "saved_object_attributes": {
                                        "parameter_enable": 0,
                                        "parameter_mappable": 0
                                    },
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "restore": [ -0.31, -0.29, 0.6, -0.33, 0.55, 0.78, 0.64, 0.5, 0.11, 0.78, 0.52, -0.6, -0.17, -0.9400000000000001, -0.77, 0.23 ],
                                    "saved_object_attributes": {
                                        "parameter_enable": 0,
                                        "parameter_mappable": 0
                                    },
                        ...
                        "boxes": [
                            {
                                "box": {
                                    ...
                                    "patching_rect": [ 186.5, 453.0, 52.0, 23.0 ],
                                    "text": "p interp"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 242.5, 250.0, 139.0, 23.0 ],
                                    "text": "loadmess savemode 0"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 403.0, 413.0, 177.0, 40.0 ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 237.5, 438.0, 145.0, 69.0 ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 4.0, 353.0, 121.0, 170.0 ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 399.0, 241.0, 266.0, 170.0 ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 549.0, 145.0, 70.0, 21.0 ],
                                    "text": "For testing"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 378.0, 444.0, 100.0, 23.0 ],
                                    "text": "prepend setlock"
                                }
                            },
                            {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "outlettype": [ "int", "", "" ],
                                    "parameter_enable": 0,
                                    "patching_rect": [ 140.0, 414.0, 112.0, 23.0 ]
                                }
                            },
                            {
                                "box": {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 3,
                                    "outlettype": [ "", "", "" ],
                                    "patching_rect": [ 491.0, 144.0, 40.0, 23.0 ],
                                    "restore": [ -0.714285714285714, -0.714285714285714, -0.6, -0.542857142857143, -0.457142857142857, -0.342857142857143, -0.171428571428571, -0.028571428571429, 0.028571428571428, 0.142857142857143, 0.228571428571429, 0.371428571428571, 0.485714285714286, 0.571428571428571, 0.714285714285714, 0.8 ],
                                    "saved_object_attributes": {
                                        "parameter_enable": 0,
                                        "parameter_mappable": 0
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 140.0, 250.0, 102.0, 23.0 ],
                                    "saved_object_attributes": {
                                        "client_rect": [ 4, 44, 358, 172 ],
                                        "parameter_enable": 0,
                                        "parameter_mappable": 0,
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "outlettype": [ "" ],
                                    "parameter_enable": 0,
                                    "patching_rect": [ 185.0, 285.0, 100.0, 24.0 ]
                                }
                            }
                        ],
                        "lines": [
            ...
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 650.0, 3.0, 50.0, 22.0 ],
                    "text": "p ?",
                    "varname": "q_tab"
                }
            }
